...
package oepool.frontend.dao;

import oepool.frontend.model.WalletData;

import java.util.List;

public interface WalletDataDao {

    List<WalletData> loadData(String wallet, long startTimeStamp, long endTimeStamp);

    List<WalletData> loadByWorkerName(String wallet, String workerName);
    List<WalletData> loadAllData();

    List<WalletData> loadWallets();
}
